...
![Pods de monitoreo en GKE: Prometheus, Grafana y node-exporter en estado OK](docs/manuales/img/gcp2.png)

<!-- Pendiente: agregar captura docs/img/prometheus-grafana/prometheus-targets.png -->
