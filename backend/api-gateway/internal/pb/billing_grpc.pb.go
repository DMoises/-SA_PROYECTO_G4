...
type BillingServiceClient interface {
	GetPlans(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*GetPlansResponse, error)
...
func (c *billingServiceClient) GetPlans(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*GetPlansResponse, error) {
...
type BillingServiceServer interface {
	GetPlans(context.Context, *Empty) (*GetPlansResponse, error)
...
func (UnimplementedBillingServiceServer) GetPlans(context.Context, *Empty) (*GetPlansResponse, error) {
