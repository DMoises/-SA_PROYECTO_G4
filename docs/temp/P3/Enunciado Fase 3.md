...
[Escudo oficial de la Universidad San Carlos de Guatemala. Escudo circular con ornamentación heráldica. En el centro aparece la figura de un hombre con toga. Rodeado por las inscripciones: "CAROLINA ACADEMIA", "GOAT MALA", "ID ET SINIS TERNI", "ORBIS CONSPICUA", "CARRETERAS". Diseño en blanco y negro con estilo universitario clásico.]

[Logo de la ECYS – Escuela de Ingeniería en Ciencias y Sistemas. Letras grandes "ECYS" en negro con un símbolo de graduado en la parte superior izquierda. A la derecha: texto "ESCUELA DE / INGENIERÍA EN CIENCIAS Y SISTEMAS / FACULTAD DE INGENIERÍA" sobre fondo azul. Debajo: "UNIVERSIDAD DE SAN CARLOS DE GUATEMALA".]
...
- Manuales de infraestructura, operaciones y pruebas:
  ...
  - **Documentación sobre Prometheus y Grafana:**
    ...
    basado en series temporales por recolección activa (*scraping*) y el
